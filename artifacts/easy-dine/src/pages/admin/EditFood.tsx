...
export default function AdminEditFood() {
  ...
  const { foodItems, updateFoodItem, shops } = useAppState();
      ...
      <div className="z-10 relative flex flex-col min-h-full px-4 pt-6 max-w-2xl mx-auto w-full">
        ...
        <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-xl rounded-[32px] p-6 shadow-xl border border-white/20 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[14px] font-bold text-gray-300">Food Image</label>
            <div 
          ...
          <button 
            type="submit"
            className="w-full mt-4 bg-blue-600 text-white py-4 rounded-xl font-bold text-[16px] shadow-[0_4px_14px_rgba(37,99,235,0.4)] hover:bg-blue-700 active:scale-[0.98] transition-all"
          >
            Save Changes
          </button>
        </form>
