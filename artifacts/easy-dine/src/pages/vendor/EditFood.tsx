            ...
            <div>
              ...
              <div className="flex bg-gray-100 rounded-xl p-1 shadow-inner">
                <button
                  type="button"
                  onClick={() => setDiet("veg")}
                  className={`flex-1 py-2.5 text-[14px] font-bold rounded-lg transition-all ${diet === "veg" ? 'bg-white text-green-600 shadow-sm' : 'text-gray-500 hover:text-slate-700'
                    }`}
                >
                  Vegetarian
                </button>
                <button
                  ...
                  className={`flex-1 py-2.5 text-[14px] font-bold rounded-lg transition-all ${diet === "nonVeg" ? 'bg-white text-[#FF3B30] shadow-sm' : 'text-gray-500 hover:text-slate-700'
                    }`}
                >
                  Non-Vegetarian
                </button>
